...
config.resolver.blockList = [
  ...
  new RegExp(path.resolve(__dirname, "packages", "expo-custom-module", "node_modules", "react-native")),
];
...
config.watchFolders = [path.resolve(__dirname, "packages", "expo-custom-module")];
